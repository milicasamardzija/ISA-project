    ...
    <nav class="navbar navbar-expand-sm navbar-light bg-light"> 
        ...
        <ul class="navbar-nav ml-auto"> 
            ...
            <li class="nav-item"> <button  type="button" class="btn btn-success"><router-link to="/client">KLIJENT</router-link></button> </li> 
             <li class="nav-item"> <button  type="button" class="btn btn-success"><router-link to="/administrator">Administrator</router-link></button> </li>
             <li class="nav-item"> <button  type="button" class="btn btn-success"><router-link to="/fishingInstructor">Fishing instructor</router-link></button> </li>    
         </ul>
        </div>
    </nav>
