        ...
        <div class=" tab-pane  active containerInfo"> 
            ...
            <div class="row-boats ">
                <div class = "col-with-picture" style="margin-right: 5%;  margin-top: 1%">
                        <div><img src="../../assets/cottageImages/galerija-vikendica-pustolov-uvac-20.jpg" class=" rounded img-thumbnail img-fluid" alt="Responsive image"  style="max-height:250px !important; max-width:300px !important" ></div>
                </div>
                ...
                <div class="col-info" style="margin-left: 10%; margin-top: 4%">
                   <div class="row" style="margin-bottom: 15%" > <button class="btn btn-secondary" data-target="#delete" data-toggle="modal"> Obrisi vikendicu </button></div> 
                   <div class="row"><button class="btn btn-success" href="">Prikazi vikendicu </button></div>   </div>
            </div>
        </div>
    ...
    <div class="modal-dialog" >
      ...
      <div class="modal-content">
        <div class="modal-header" >
          <h5 class="modal-title" id="exampleModalLabel" style="color:#0B4025; padding: 5px 35px">Brisanje vikendice</h5>
        </div>
        <div class="modal-body" style="padding:15px 50px;" >
            <form role="form">
                <div  class="form-group"> 
                 <label for="psw"><span class="glyphicon glyphicon-eye-open"></span> Da li ste sigurni da zelite da obrisete ovu vikendicu?</label>
                </div> 
