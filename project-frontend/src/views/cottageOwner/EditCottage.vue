    ...
    <div class="tab-pane active containerInfo">
      <div class="row">
        ...
        <div class="column" style="width: 18rem; height: 3rem">
          <button class="btn btn-success">Sacuvaj izmene</button>
        </div>
      </div>
      ...
      <div class="row aboutCottage">
        ...
        <div class="column" style="padding-left: 5rem; width: 50em">
          <h4>Informacije</h4>
          <div class="row" style="height: 20rem; background: whitesmoke">
            <div class="column" style="width: 18rem">
              <table>
                ...
                <tr>
                  <td><p>Maksimalan broj osoba:</p></td>
                  <td><input type="text" /></td>
                </tr>
                <tr>
                  <td><p>Broj soba:</p></td>
